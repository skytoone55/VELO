...
def clean_siret(val):
    """Extract exactly 14 digits from a SIRET value, stripping spaces/punctuation."""
    if val is None:
        return ''
...
print(f"{'='*60}")
print(f"  COMPARAISON PAR SIRET (14 chiffres, espaces retires)")
print(f"{'='*60}\n")
