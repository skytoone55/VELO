            ...
            <td>
              ...
              <div style="margin: 28px 0 8px 0; padding: 18px 20px; background-color: #fff7ed; border-left: 4px solid ${tenant.branding.colors.secondary}; border-radius: 6px;">
                ...
                <p style="margin: 0; color: #111827; font-size: 17px; line-height: 1.6; font-weight: 600;">
                  <span style="white-space: nowrap;">✉️&nbsp;<a href="mailto:${tenant.email}" style="color: ${tenant.branding.colors.secondary}; text-decoration: none;">${tenant.email}</a></span>
                  &nbsp;·&nbsp;
                  <span style="white-space: nowrap;">📞&nbsp;<a href="tel:${tenant.phone}" style="color: ${tenant.branding.colors.secondary}; text-decoration: none;">${tenant.phoneFormatted.replace(/ /g, '\u00A0')}</a></span>
                </p>
              </div>
            </td>
          </tr>
